...
public class TimePickerView3 extends BasePickerView implements View.OnClickListener {
    ...
    public TimePickerView3(PickerOptions pickerOptions) {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            if (mPickerOptions.type[3]||mPickerOptions.type[4]||mPickerOptions.type[5]){
                findViewById(R.id.timepickerchilde_tv).setVisibility(View.VISIBLE);
                findViewById(R.id.timepickerchilde_ll).setVisibility(View.VISIBLE);
            }
            //顶部标题
        ...
        timePickerView.setPadding(0,0,0,getNavigationBarHeight(context));
